---
name: interview-prep
description: 为已经收到或即将参加各行业、各职能岗位面试的用户生成当前轮次的针对性准备文档。先确认公司、岗位、完整 JD 和面试轮次，动态建立岗位画像，再由用户指定 experience-deepthink 经历深挖产物或上传简历；研究公司、业务领域和岗位背景，按岗位选择高相关面经和专业来源，输出前短后长的面试作战手册，包含快速复习区、金字塔式 90 秒自我介绍、公司与岗位认知、专业知识补齐、2–3 张个人经历战斗卡、分层的 10 道公司与岗位场景题及个性化参考答案、候选人反问和完整来源链接。AI 产品及 AI+行业产品岗位加载专项岗位指南，准备项目证据链、技术选型、评测治理和与真实经历相连的术语突袭。用户说“收到面试邀请了”“帮我准备某公司某岗位一面/二面/终面/HR 面”“根据 JD 准备面试”“结合我的经历做面试准备”时使用；先在聊天中交付，用户确认后才保存飞书。不进入一题一答模拟，也不处理笔试。
---
...
→ 经历战斗卡追问 / 基础风险题 / 正式十题 → 个人参考答案与证据缺口
```

先按 `references/question-prediction.md` 从面经、JD、公司/业务动态、岗位专业知识、用户经历
钩子以及本轮面试性质六类信号生成 15–25 道候选问题，记录每题的预测依据、关联能力和可用个人
证据。再按 `references/question-archetypes.md` 检查动机、履历、个人贡献、专业方法、决策、
协作、失败和系统判断的覆盖；问题原型只做覆盖审计，不能替代证据驱动的预测。

用户个人经历的深挖题进入战斗卡；通用但高风险的问题进入自我介绍预计追问或快速复习区；只有
依赖目标公司、组织场景、专业领域或岗位背景的问题才进入正式十题。

AI 术语只选择与 JD、面经或用户经历高相关的少数概念，不把正式十题改造成通用术语测验。概念
回答必须包含产品决策含义；项目材料没有相应机制时，不以“会解释术语”包装成做过该项目。
AI 产品岗位的经历战斗卡还要标明项目成熟度、一条具体实例、指标口径、个人所有权和限制；
这些内容只从用户材料取得。术语按“本质—相邻概念—PM 决策—项目边界”组织，没有使用过的
机制明确说没有，不为形成答案而嫁接。
...
材料、AI Agent 项目案例与 AI 面试复盘交叉提炼。只吸收稳定的岗位验证维度、项目战斗卡和
