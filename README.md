...
npx skills add riwonswain-ovo/OfferLoop -g \
  ...
  offerloop-workbench offerloop-agent resume-deepthink interview-prep mock-lab talk-review pm-sense -y
```
...
npx skills update offerloop-setup job-collection recruiting-reminder \
  offerloop-workspace offerloop-workbench offerloop-agent resume-deepthink interview-prep mock-lab \
